...
use super::{
    ...
    PFRingProcessPacket, PFRingStat, PacketDirection, PacketSlicingLevel, SocketMode,
    ThirdpartyFunc,
};
use dlopen::wrapper::WrapperApi;
use libc::{c_char, c_double, c_int, c_uchar, c_uint, c_ushort, timespec};
...
pub struct PFRingDll {
    //startup/shutdown
    pfring_open:
        unsafe extern "C" fn(device_name: *const c_char, caplen: u32, flags: u32) -> *mut PFRing,
    pfring_open_multichannel: unsafe extern "C" fn(
        device_name: *const c_char,
        caplen: u32,
        flags: u32,
        output: *mut [*mut PFRing; MAX_NUM_RX_CHANNELS],
    ) -> u8,
    ...
    pfring_set_application_name:
        unsafe extern "C" fn(ring: *mut PFRing, name: *const c_char) -> c_int,
    ...
    pfring_set_direction:
        unsafe extern "C" fn(ring: *mut PFRing, direction: PacketDirection) -> c_int,
    ...
    pfring_set_poll_watermark_timeout:
        unsafe extern "C" fn(ring: *mut PFRing, poll_watermark_timeout: u16) -> c_int,
    ...
    pfring_get_appl_stats_file_name:
        unsafe extern "C" fn(ring: PFRing, path: *mut c_char, path_len: c_uint) -> c_int,
    pfring_set_packet_slicing: unsafe extern "C" fn(
        ring: *mut PFRing,
        packet_level: PacketSlicingLevel,
        additional_bytes: u32,
    ) -> c_int,
    pfring_set_socket_mode: unsafe extern "C" fn(ring: *mut PFRing, mode: SocketMode) -> c_int,
    pfring_set_cluster: unsafe extern "C" fn(
        ring: *mut PFRing,
        cluster_idd: c_uint,
    ...
    pfring_set_reflector_device:
        unsafe extern "C" fn(ring: *mut PFRing, device_name: *mut c_char) -> c_int,
    pfring_set_bound_dev_name:
        unsafe extern "C" fn(ring: *mut PFRing, custom_dev_name: *mut c_char) -> c_int,

    // rules
    pfring_remove_filtering_rule: unsafe extern "C" fn(ring: *mut PFRing, rule_id: u16) -> c_int,
    pfring_set_application_stats:
        unsafe extern "C" fn(ring: *mut PFRing, stats: *mut c_char) -> c_int,
    pfring_purge_idle_hash_rules:
        unsafe extern "C" fn(ring: *mut PFRing, inactivity_sec: u16) -> c_int,
    pfring_purge_idle_rules: unsafe extern "C" fn(ring: PFRing, inactivity_sec: u16) -> c_int,
    pfring_get_filtering_rule_stats: unsafe extern "C" fn(
        ring: *mut PFRing,
        rule_id: u16,
        stats: *mut char,
    ...
    pfring_toggle_filtering_policy:
        unsafe extern "C" fn(ring: *mut PFRing, rules_default_accept_policy: u8) -> c_int,
    pfring_set_bpf_filter:
        unsafe extern "C" fn(ring: *mut PFRing, filter_buffer: *mut c_char) -> c_int,
    ...
    pfring_get_metadata: unsafe extern "C" fn(
        ring: *mut PFRing,
        metadata: *mut *mut u8,
    ...
    pfring_get_bound_device_address:
        unsafe extern "C" fn(ring: *mut PFRing, mac_address: *mut c_uchar) -> c_int,
    pfring_get_bound_device_ifindex:
        unsafe extern "C" fn(ring: *mut PFRing, if_index: *mut c_int) -> c_int,
    ...
    pfring_adjust_device_clock:
        unsafe extern "C" fn(ring: *mut PFRing, offset: *mut timespec, sign: i8) -> c_int,
    ...
    pfring_get_device_ifindex: unsafe extern "C" fn(
        ring: *mut PFRing,
        device_name: *const c_char,
        if_index: *mut c_int,
    ) -> c_int,
    ...
    pfring_next_pkt_raw_timestamp:
        unsafe extern "C" fn(ring: *mut PFRing, timestamp_ns: *mut u64) -> c_int,

    pfring_loopback_test: unsafe extern "C" fn(
        ring: *mut PFRing,
        buffer: *mut c_char,
        buffer_len: c_uint,
        test_len: c_uint,
    ...
    //sending/receiving
    pfring_recv: unsafe extern "C" fn(
        ring: *const PFRing,
        buffer: *mut *mut u8,
        buffer_len: c_uint,
    ...
    pfring_recv_parsed: unsafe extern "C" fn(
        ring: *const PFRing,
        buffer: *mut *mut u8,
        buffer_len: c_uint,
        hdr: *mut PFRingPacketHeader,
    ...
    pfring_send: unsafe extern "C" fn(
        ring: *const PFRing,
        pkt: *const u8,
        pkt_len: c_uint,
        flush_packet: u8,
    ) -> c_int,
    pfring_send_get_time: unsafe extern "C" fn(
        ring: *const PFRing,
        pkt: *const u8,
        pkt_len: c_uint,
        ts: *mut timespec,
    ...
    pfring_loop: unsafe extern "C" fn(
        ring: *mut PFRing,
    ...
    pfring_send_last_rx_packet:
        unsafe extern "C" fn(ring: *mut PFRing, tx_interface_id: c_int) -> c_int,
    pfring_recv_chunk: unsafe extern "C" fn(
        ring: *mut PFRing,
        chunk: *mut *mut (),
    ...
    pfring_search_payload:
        unsafe extern "C" fn(ring: *mut PFRing, string_to_search: *mut c_char) -> c_int,

    pfring_parse_pkt: unsafe extern "C" fn(
        pkt: *mut c_uchar,
        hdr: *mut PFRingPacketHeader,
        level: u8,
        add_timestamp: u8,
    ...
    pfring_format_numbers: unsafe extern "C" fn(
        val: c_double,
        buf: *mut c_char,
        buf_len: c_uint,
        add_decimals: u8,
    ) -> *mut c_char,
    pfring_enable_hw_timestamp: unsafe extern "C" fn(
        ring: *mut PFRing,
    ...
    pfring_print_parsed_pkt: unsafe extern "C" fn(
        buff: *mut c_char,
        buff_len: c_uint,
        p: *const c_uchar,
        h: *const PFRingPacketHeader,
    ) -> c_int,
    pfring_print_pkt: unsafe extern "C" fn(
        buff: *mut c_char,
        buff_len: c_uint,
        p: *const c_uchar,
        len: c_uint,
    ...
    pfring_read_ixia_hw_timestamp:
        unsafe extern "C" fn(buffer: *mut c_uchar, buffer_len: u32, ts: *mut timespec) -> c_int,
    pfring_handle_ixia_hw_timestamp:
        unsafe extern "C" fn(buffer: *mut c_uchar, hdr: *mut PFRingPacketHeader),
    ...
    pfring_parse_bpf_filter: unsafe extern "C" fn(
    ...
    pfring_bpf_filter:
        unsafe extern "C" fn(bpf_insn: *mut (), buffer: *mut c_uchar, caplen: u32, len: u32) -> u32,
    pfring_thirdparty_lib_init: unsafe extern "C" fn(
