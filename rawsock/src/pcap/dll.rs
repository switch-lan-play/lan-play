...
use libc::{c_char, c_int, c_long, c_uchar, c_uint, FILE};
...
pub use crate::pcap_common::{
    BpfProgram, PCapDirection, PCapDumper, PCapHandle, PCapHandler, PCapInterface, PCapPacketHeader,
};
...
pub struct PCapDll {
    pcap_create:
        unsafe extern "C" fn(devicename: *const c_char, errbuf: *mut c_char) -> *const PCapHandle,
    ...
    pcap_open_offline_with_tstamp_precision: unsafe extern "C" fn(
        fname: *const c_char,
        precision: c_uint,
        errbuf: *mut c_char,
    ) -> *const PCapHandle,
    pcap_open_offline:
        unsafe extern "C" fn(fname: *const c_char, errbuf: *mut c_char) -> *const PCapHandle,
    pcap_fopen_offline:
        unsafe extern "C" fn(fp: *mut FILE, errbuf: *mut c_char) -> *const PCapHandle,
    pcap_fopen_offline_with_tstamp_precision: unsafe extern "C" fn(
        fp: *mut FILE,
        precision: c_uint,
        errbuf: *mut c_char,
    ) -> *const PCapHandle,
    pcap_open_dead: unsafe extern "C" fn(linktype: c_int, snaplen: c_int) -> *const PCapHandle,
    pcap_open_dead_with_tstamp_precision: unsafe extern "C" fn(
        linktype: c_int,
        snaplen: c_int,
        precision: c_uint,
    ) -> *const PCapHandle,
    ...
    pcap_list_tstamp_types:
        unsafe extern "C" fn(p: *const PCapHandle, tstamp_typesp: *mut *mut c_int) -> c_int,
    ...
    pcap_set_tstamp_precision:
        unsafe extern "C" fn(p: *const PCapHandle, tstamp_precision: c_int) -> c_int,
    pcap_get_tstamp_precision: unsafe extern "C" fn(p: *const PCapHandle) -> c_int,
    pcap_set_immediate_mode:
        unsafe extern "C" fn(p: *const PCapHandle, immediate_mode: c_int) -> c_int,
    ...
    // sending/receiving
    pcap_sendpacket:
        unsafe extern "C" fn(handle: *const PCapHandle, buf: *const u8, size: c_int) -> c_int,
    pcap_inject:
        unsafe extern "C" fn(handle: *const PCapHandle, buf: *const (), size: isize) -> c_int,
    pcap_next:
        unsafe extern "C" fn(handle: *const PCapHandle, header: *mut PCapPacketHeader) -> *const u8,
    pcap_next_ex: unsafe extern "C" fn(
    ...
    pcap_setnonblock: unsafe extern "C" fn(
        handle: *const PCapHandle,
        nonblock: c_int,
        errbuf: *mut c_char,
    ) -> c_int,
    ...
    pcap_loop: unsafe extern "C" fn(
        handle: *const PCapHandle,
        cnt: c_int,
        callback: PCapHandler,
        user: *mut c_uchar,
    ) -> c_int,
    pcap_dispatch: unsafe extern "C" fn(
        handle: *const PCapHandle,
        cnt: c_int,
        callback: PCapHandler,
        user: *mut c_uchar,
    ...
    //filtering
    pcap_compile: unsafe extern "C" fn(
        handle: *const PCapHandle,
        fp: *mut BpfProgram,
        str: *const c_char,
        optimize: c_int,
    ...
    pcap_lookupnet: unsafe extern "C" fn(
        device: *const c_char,
        netp: *mut u32,
        maskp: *mut u32,
        errbuf: *mut c_char,
    ) -> c_int,
    pcap_offline_filter: unsafe extern "C" fn(
        fp: *const BpfProgram,
    ...
    //dump
    pcap_dump_open:
        unsafe extern "C" fn(handle: *const PCapHandle, fname: *const c_char) -> *mut PCapDumper,
    pcap_dump_open_append:
        unsafe extern "C" fn(handle: *const PCapHandle, fname: *const c_char) -> *mut PCapDumper,
    pcap_dump_fopen:
        unsafe extern "C" fn(handle: *const PCapHandle, fp: *mut FILE) -> *mut PCapDumper,
    ...
    //datalinks
    pcap_list_datalinks:
        unsafe extern "C" fn(p: *const PCapHandle, dlt_buf: *mut *mut c_int) -> c_int,
    ...
    //devices
    pcap_findalldevs:
        unsafe extern "C" fn(alldevsp: *mut *const PCapInterface, errbuf: *const c_char) -> c_int,
